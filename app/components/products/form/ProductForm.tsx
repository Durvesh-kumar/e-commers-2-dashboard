                    ...
                    <FormField
                        ...
                        render={({ field }) => (
                            <FormItem>
                                ...
                                <FormControl>
                                    <Input type="number" placeholder="Please Enter price" onKeyDown={handelKeyPress} {...field} className="w-full" />
                                </FormControl>
                                <FormMessage className=" text-sm text-orange-500" />
                            </FormItem>
                        )}
                    ...
                    <FormField
                        ...
                        render={({ field }) => (
                            <FormItem>
                                ...
                                <FormControl>
                                    <Input type="number" placeholder="Please Enter pay" onKeyDown={handelKeyPress} {...field} className="w-full" />
                                </FormControl>
                                <FormMessage className=" text-sm text-orange-500" />
                            </FormItem>
                        )}
